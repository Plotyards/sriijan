...
const testimonials = [
  {
    name: "Rajesh Kumar",
    location: "Mumbai",
    text: "Before Promohomex, I had no idea what was happening with my under-construction flat. Now I get regular drone video surveys and stage completion alerts. Completely stress-free experience!",
    rating: 5,
  },
  {
    name: "Sneha Patel",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-3 text-base sm:text-lg text-slate-600 font-medium">
            See how Promohomex is bringing complete peace of mind to real estate owners.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, idx) => (
            <div
              key={idx}
              className="bg-slate-50 rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-lg hover:border-amber-400 transition-all duration-300 flex flex-col justify-between"
            >
              <div>
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                <div className="w-10 h-10 rounded-full bg-amber-500 text-slate-950 font-extrabold text-sm flex items-center justify-center shadow-xs">
                  {t.name.charAt(0)}
                </div>
                <div>
