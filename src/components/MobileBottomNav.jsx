...
const MobileBottomNav = () => {
  ...
  return (
    ...
    >
      <Link
        to="/dashboard"
        className="pointer-events-auto relative overflow-hidden flex items-center justify-between w-full max-w-[360px] bg-white text-slate-900 py-3 px-4 rounded-[2rem] shadow-2xl transition-all active:scale-95 group border border-slate-200"
      >
