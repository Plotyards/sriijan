...
const faqs = [
  {
    question: "Is Sriizan free for homebuyers?",
  ...
  },
  {
    ...
    answer: "Sriizan analyzes current builder price list revisions, recent micro-market resale transactions in your sector, and infrastructure completion timelines to provide accurate resale valuations."
  },
  {
    question: "Can I list my property directly on Plotyards for resale?",
    answer: "Yes! Integrated Plotyards support allows you to request instant resale listings and connect with active buyers directly from your Sriizan AI dashboard."
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="mt-3 text-slate-600 text-base sm:text-lg font-medium">
            Everything you need to know about tracking your property on Sriizan.
          </p>
        </div>
              ...
              >
                ...
                >
                  <span className="font-black text-slate-900 text-sm sm:text-base pr-4 flex items-center gap-2.5">
                    <HelpCircle size={19} className="text-emerald-600 shrink-0" />
                    {faq.question}
                  </span>
                  <ChevronDown
                    size={18}
